...
exports.createVerifyProofInstruction = void 0;
 ...
 * @category generated
 */
var verifyProofStruct = new beet.BeetArgsStruct([
    ['instructionDiscriminator', beet.uniformFixedSizeArray(beet.u8, 8)],
    ['poolBump', beet.u8],
    ['proofBump', beet.u8],
], 'VerifyProofInstructionArgs');
var verifyProofInstructionDiscriminator = [
 ...
 * @category generated
 */
function createVerifyProofInstruction(accounts, args) {
    var pool = accounts.pool, proof = accounts.proof, authority = accounts.authority, payer = accounts.payer;
    var data = verifyProofStruct.serialize(__assign({ instructionDiscriminator: verifyProofInstructionDiscriminator }, args))[0];
    var keys = [
        {
            pubkey: pool,
            isWritable: false,
...
exports.createVerifyProofInstruction = createVerifyProofInstruction;
